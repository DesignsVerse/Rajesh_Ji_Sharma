...
const index = () => {
    return (
        <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 m-32'>
            ...
            <h3 className="text-2xl font-medium text-center pt-10 animate-fade-in-up hover:scale-105 transition-transform duration-300">"Pandit Ji Honors Only the Best: Excellence Deserves Recognition!"</h3>
            <h2 className="text-2xl font-medium text-center pt-10 animate-pulse hover:scale-105 transition-transform duration-300">"Pandit Ji Rajesh has received so many awards!" <br /> Jyotish Ratna Award,
