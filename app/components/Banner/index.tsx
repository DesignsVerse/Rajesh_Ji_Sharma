            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 my-1 gap-10 text-black'> {/* Adjusted gap */}
                ...
                <div className="mx-auto sm:mx-0 flex flex-col items-center lg:items-start">
                    ...
                    <div className='my-7 text-center lg:text-start'>
                        <button className='text-sm md:text-xl font-semibold hover:shadow-lg transition duration-300 bg-blue text-white py-3 px-6 md:py-5 md:px-14 rounded-full hover:bg-black'>
                            Get Started
                        </button>
                    </div>
                </div>
